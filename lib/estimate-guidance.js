...
export function estimateInput(raw={}){
 ...
 const labor=laborRateForDifficulty(raw.job_difficulty);x.job_difficulty=labor.difficulty;x.labor_rate=labor.rate;x.labor_rate_provisional=labor.provisional;
 return x;
}
