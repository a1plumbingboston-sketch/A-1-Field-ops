const CACHE='a1-fieldops-v31.8.1';
const ASSETS=['./','./index.html','./styles.css','./document-system.js','./document-system.css','./a1-logo.png','./manifest.webmanifest','./employee.html','./employee.js','./employee.css','./employee.webmanifest'];
