const CACHE='a1-fieldops-v31.8.2';
const ASSETS=['./','./index.html','./styles.css','./warm-premium.css?v=31.8.2','./document-system.js','./document-system.css','./a1-logo.png','./manifest.webmanifest','./employee.html','./employee.js','./employee.css','./employee.webmanifest'];
